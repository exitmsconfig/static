...
(function($, window, document, undefined) {
    ...
    Video.prototype.loadVideo = function(src, addClass, noposter, index, html) {
        ...
        if (isVideo.youtube) {
            ...
            video = '<iframe class="lg-video-object lg-vimeo ' + addClass + '" width="560" height="315"  src="' + isVideo.vimeo[1] + a + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
